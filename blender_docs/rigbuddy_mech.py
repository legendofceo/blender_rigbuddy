...
class leg(abstract):
    ...
    bonelayer_control_legik = None
    bonelayer_control_legfk = None
    bonelayer_bone_basic = None
    bonelayer_mech_ik = None        
            
    controlshape_foot_ik = None
    controlshape_thigh_fk = None
    controlshape_shin_fk = None
    controlshape_foot_fk = None
    ...
    thigh_parent = None
    m_thigh_parent = None
    thigh_poarent_mech_socket = None
    
    

            
    m_thigh_twist1_tweak = None
    thigh_twist1_tweak = None
